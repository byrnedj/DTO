...
int main(int argc, char **argv)
{
	...
	if (argc != 10) {
		printf("Usage: dto-test-distribution num_threads sleep_time num_iters mem_buf_size num_mem_bufs use_random_index src_numa_policy dst_numa_policy input_file_path\n");
		exit(0);
	}
