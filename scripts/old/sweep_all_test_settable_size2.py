...
num_iter = num_iter = args.num_iter  #10000000 #1000000
...
name = 'sweepalltest2_{}_{}'.format(run_name, output_type)
                            ...
                            for perc in percentages:
                                ...
                                for size in sizes:
                                    if scale_buf_sizes_with_tx_size and size != mem_buf_size:
                                        continue
                                    output_name = '{}_{}_{}_{}_{}_{}_{}_{}_{}_{}K'.format(op_name,numa_config,perc.replace(".", "-"),wait,alloc,cache_control,r,num_b,mem_buf_size,size)
                                    ...
                                    if alloc == 'single':
                                        ...
                                        dto_command = dto_command_base + [str(num_threads), str(0), str(mem_op), str(size), str(num_iter), str(alloc_size), '1', '0','1', '1']
                                    else:
                                        dto_command = dto_command_base + [str(num_threads), str(0), str(mem_op), str(size), str(num_iter), str(mem_buf_size), str(num_b), str(r),'1', '1']
