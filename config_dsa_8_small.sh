...
accel-config load-config -c /home/jjsydir/internal_dto/projects.research.dto_dev/dto-8-dsa-small-q.conf
...
chmod o+rw /dev/dsa/wq8.0
chmod o+rw /dev/dsa/wq10.0
chmod o+rw /dev/dsa/wq12.0
chmod o+rw /dev/dsa/wq14.0
